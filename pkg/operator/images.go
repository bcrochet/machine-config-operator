...
type RenderConfigImages struct {
	...
	KeepalivedBootstrap          string `json:"keepalivedImage"`
	CorednsBootstrap             string `json:"corednsImage"`
	BaremetalRuntimeCfgBootstrap string `json:"baremetalRuntimeCfgImage"`
}
